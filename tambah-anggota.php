	...
	<div class="container">
		<div class="row">
			<div class="col-md-12 border rounded shadow-sm mt-4 mb-4">
				<h4 class="pt-4 pb-3 mermaid text-center">Tambah Data Anggota</h4>
				<form action="proses-tambah-anggota.php" method="POST" enctype="multipart/form-data">
					<?php 
						include "koneksi.php";
					...
					<table class="table table-borderless"  style="width:15cm">
						...
						<tr>
							<td>Foto</td>
							<td>:</td>
							<td><input type="file" name="foto_anggota"></td>
						</tr>
						<tr>
							<td>Tempat Lahir</td>
							<td>:</td>
